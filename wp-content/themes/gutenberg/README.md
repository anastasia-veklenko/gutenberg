...
$ git clone https://gitlab.test.se/dmitriy.olhovsky/test-starter.git
$ rename test-theme folder (better with underscores or together like in 'twentyseventeen')
$ cd your_theme_name
```
...
$ find & replace in the whole theme 'test_' and 'test' with the name of your theme
