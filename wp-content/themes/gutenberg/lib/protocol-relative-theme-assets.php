...
if ( ! class_exists( 'test_Protocol_Relative_Theme_Assets' ) ) :
	class test_Protocol_Relative_Theme_Assets {
		/**
	...
	$test_protocol_relative_theme_assets = new test_Protocol_Relative_Theme_Assets;
endif;
